...
def abrir_tela_saidas(janela):
    ...
    tipo_pesquisa['values'] = ["Tudo", "Por nome", "Por categoria", "Nome + Categoria", "Por responsável"]
    ...
    tk.Button(frame_botoes, text="🔍 Buscar", width=15,
              command=lambda: buscar_produtos_saidas(tipo_pesquisa, entrada_nome, categoria_box, entrada_responsavel, tabela)
